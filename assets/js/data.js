...
window.SITES = [
  {
    ...
    summary:"Just after 3am on 26 December 1980, three American airmen walked into Rendlesham Forest expecting the wreckage of a downed plane. What they reported instead has never been settled. They described lights moving through the trees, then a small triangular craft, metallic, resting silent in a clearing, its surface marked with symbols none of them recognised. It moved off through the pines before they could reach it. Two nights later the deputy base commander, Lieutenant Colonel Charles Halt, went in with a team and a tape recorder, and captured, live, lights that split apart, moved against the wind, and appeared to send beams down toward the weapons storage area of a base that held nuclear weapons. Impressions in the forest floor and raised radiation readings were logged at the site. The prosaic case is real and partly persuasive. The nearby Orford Ness lighthouse accounts for a steady light on the horizon, and a bright meteor burned up over the region that night. What neither cleanly explains is the close-range, structured object that trained security personnel say they stood feet from. Halt has never retracted a word. Forty years on, it is the <strong>best-documented UFO case in British history</strong>, and the least explained.",
    cases:[
  ...
  },
  {
    ...
    summary:"No single night made Cannock Chase strange. It is the sheer variety that unsettles: on one stretch of Staffordshire forest, people report lights, a dogman, black-eyed children, a big cat and wartime ghosts, as if the ground itself attracts the anomalous. The aerial side is the most concrete. The Chase appears in Ministry of Defence UFO files, and in 2015 several witnesses reported a large craft with three red lights holding still over the trees. The rest is a mix of the genuinely reported and the heavily amplified. The black-eyed child encounters near Birches Valley recur in sincere accounts and in tabloid cycles in roughly equal measure, and the dogman and 'black panther' sightings have the folkloric quality of stories that grow in the retelling. What makes the place hard to dismiss is not any one report but the clustering, the same convergence that defines Skinwalker Ranch. What makes it hard to trust is the setting: a large, dark forest beside dense towns, carrying the real weight of the 1960s child murders committed here. That is close to a perfect engine for lore, whether or not anything genuine sits behind it. <strong>Take the cluster seriously. Hold the cause open.</strong>",
    cases:[
  ...
  },
  {
    ...
    summary:"It did not start with a crash or a landing. It started, in 1992, with one man on a road outside a small Scottish town seeing a light he could not place, and then hundreds of his neighbours saying the same thing. Bonnybridge sits at a corner of the Falkirk Triangle, and for a decade it recorded strange skies on a scale nowhere else in Britain matched: on the order of 300 reports a year, orange and white spheres, silent triangles, objects that moved in ways aircraft do not. Most came not from enthusiasts but from ordinary residents. The volume grew loud enough that a local councillor, Billy Buchanan, took the case to successive prime ministers and called for a formal inquiry that never came. There is no smoking gun here, and that is the point. This is a case built on quantity, not on any single unimpeachable event, and quantity cuts both ways: a genuine sustained phenomenon would look like this, and so would a reputation feeding on itself, drawing sightings the way a lit window draws moths. <strong>Thirty years on, what actually happened over Bonnybridge is still, honestly, unresolved.</strong>",
    cases:[
  ...
  },
  {
    ...
    summary:"For most of the 1960s, people in this Wiltshire town did not see a UFO so much as hear one: a sound in the dark they called, simply, 'the Thing.' A crackling, droning pressure overhead that drove some to the ground and sent others rushing outside to look. What turned that sound into Britain's first mass UFO event was one man. Arthur Shuttlewood, a journalist at the Warminster Journal, chronicled the reports until they became the story of the town, and night after night crowds climbed Cradle Hill to watch the sky. At the peak, a single August weekend in 1965 drew an estimated 8,000 people. But this is a case that curdles the closer you look. The emblematic photograph of the Thing, taken by local man Gordon Faulkner in 1965 and splashed across the Daily Mirror, was later exposed as a hoax. Shuttlewood himself drifted from sceptical reporter to believer to something stranger still, eventually claiming telepathic contact with beings from a planet called Aenstria. And the town sits ringed by the military airspace of Salisbury Plain, a ready source of odd lights and sounds. Something did start in the quiet, before the crowds and the cameras. <strong>By the time the crowds arrived, it had become impossible to tell the signal from the show.</strong>",
    cases:[
  ...
  },
  {
    ...
    summary:"In February 1977, a group of schoolchildren in Pembrokeshire ran inside to say they had seen a silver craft land in the field behind their school. Separated and asked to draw it, several produced the same shape. That sighting opened what became known as the Dyfed Triangle, a wave of reports that ran along the Welsh coast through the year: craft on the ground, and figures, tall and silver-suited, seen near farms and homes. The Broad Haven school case is the one that endures, partly because children make awkward hoaxers en masse, and partly because it arrived at the front of a genuine cluster rather than alone. The caution is real. Young witnesses can prime one another without meaning to, memory bends toward the group, and the wider Dyfed wave later attracted its share of embroidery and at least one suspected hoax. This is soft evidence, and it should be named as such. But a field full of children pointing at the same thing, on the same afternoon, is not nothing. <strong>It is exactly the kind of report that resists both belief and dismissal.</strong>",
    cases:[
  ...
  },
  {
    ...
    summary:"The lights on the hills above Longdendale were strange long before anyone thought to call them UFOs. People have reported moving lights across these Peak District slopes for centuries, under older names: the 'Devil's bonfires,' corpse candles, the will-o'-the-wisp. That long record is what makes the valley useful rather than just eerie. Because the lights predate cars, pylons and aircraft, and because a proper researcher has studied them, you can ask a cleaner question than usual: what are people actually seeing? The folklorist Dr David Clarke traced the accounts and found that the local Mountain Rescue team kept a log of them, turning out again and again to reports of lights on the moor and finding no one there. The honest weight of the evidence leans prosaic, and interestingly so. Some sightings are hikers' torches and distant headlights on hidden roads. Others fit the 'earth lights' hypothesis, luminous effects that researchers link to tectonic stress in the rock. Neither fully closes the case, but between them they cover most of it. <strong>Strange and unexplained are not the same word</strong>, and a light that has puzzled people for four hundred years may still have a plain answer.",
    cases:[
  ...
  },
  {
    ...
    summary:"Of all the entries here, this is the one to hold at arm's length, and it is only fair to say so plainly at the top. Along this stretch of the East Yorkshire coast, near the cliffs at Bempton and Flamborough, a body of reports has built up: craft, creatures, lights, encounters. It is promoted, energetically, as 'the UK Skinwalker Ranch.' The phrase is doing a lot of work. Almost all of it traces to the sustained casework of one researcher, Paul Sinclair, who has gathered and published the accounts and pressed the comparison. That does not make it false. Dedicated single investigators have surfaced real things before. But it does change what kind of claim it is. A hotspot established by many independent witnesses, official files and contemporaneous press is one thing; a hotspot established largely through one person's collected work and branding is another, and a credibility-first register has to keep the two apart. <strong>Bempton is worth tracking. It is not yet worth leaning on.</strong> We log it, watch it, and wait to see whether the evidence broadens beyond a single source.",
    cases:[
  ...
  },
  {
    ...
    summary:"For one night in February 2016, a village near Cardiff became, in the retelling, the scene of something enormous: a craft the size of a building over the woods, a smaller object thrown from it, military helicopters, explosions, damaged trees. It is a genuinely dramatic story. It is also a thin one, and the tidy official rebuttal is thinner than it first looks. Two things are firm. Real military aircraft were over Pentyrch that night, Chinooks included, on a scale that had hundreds of residents phoning the police. And the truly spectacular detail, the pyramid craft, the ejected orbs, being scanned, rests very largely on a single primary witness, Caz Clarke, and reached the public through a book she wrote with investigator Gari Jones. Between those two facts, the ground is soft. The MoD's answer has been evasive rather than clean. The activity was attributed to a routine exercise, but researchers point out that the named exercise, Chameleon, appears to have run in the north of England the week before, not in Wales, and later Freedom of Information replies leaned on national-security exemptions. So even the mundane explanation is contested. <strong>High on strangeness, low on evidence.</strong> It feels huge. On what can actually be verified, it is not yet huge, and keeping those apart is the whole job.",
    cases:[
